...
public class ScreenShot_using_getClass_Method {
	...
	public static void main(String[] args) throws IOException {
		...
		//s.getClass();
		File destination = new File("C:\\Users\\yamin\\OneDrive\\Desktop\\Selenium_SS\\Yamini" +new  ScreenShot_using_getClass_Method().getClass() +".jpg");
